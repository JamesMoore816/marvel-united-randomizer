    ...
    return (
        <div className="accordion-div">
            <Accordion disableGutters className="set-accordion" elevation={0} square sx={{ width: 420, paddingBottom:0.5 }}>
                <AccordionSummary
                    expandIcon={<ExpandMoreIcon sx={{color:"white", backgroundColor:"rgba(0,0,0,.6)", borderRadius:"100%" }}/>}
                ...
                >
                    ...
                    <Typography sx={{color:"white", fontSize:"20px", backgroundColor:"rgba(0,0,0,.6)", padding:"0px 6px 3px 6px" }}>{props.title}</Typography>
